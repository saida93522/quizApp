...
class TestQuiz(TestCase):
    ...
    def test_available_category_is_displayed(self):
        quiz = Quize_Table()  # Arrange
        list_topic = ['art', 'space', 'sport']
        self.assertEqual(list_topic,
                         quiz.display_category())

    def test_available_category_is_empty(self):
        quiz = Quize_Table()
        list_topic = []
        self.assertIsNotNone(list_topic, quiz.display_category())
    ...
    def test_get_questions_art(self):
        ...
        self.assertEqual(list_questions, quiz.get_questions(topic, qs_attempt))
    ...
    # TODO Test if 0 num_ofquestions is entered
